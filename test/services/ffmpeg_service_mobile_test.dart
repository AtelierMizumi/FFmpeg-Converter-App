...
void main() {
  group('FFmpegServiceMobile Tests', () {
    ...
    test('Should validate codec names', () {
      const validCodecs = ['libx264', 'libx265', 'libvpx-vp9', 'libaom-av1', 'copy'];
  ...
  group('Progress Parsing Tests', () {
    test('Should parse duration from FFmpeg output', () {
      const logLine = '  Duration: 00:05:30.45, start: 0.000000, bitrate: 1500 kb/s';
    ...
    test('Should parse time progress from FFmpeg output', () {
      const logLine = 'frame= 1500 fps= 30 time=00:01:00.00 bitrate= 2000.0kbits/s speed= 1.0x';
