...
class FFmpegServiceMobile implements FFmpegService {
  ...
  Future<void> initialize() async {
    debugPrint(
      "✅ FFmpegKit Mobile - Initialized with ffmpeg_kit_flutter_new v4.1.0",
    );
  ...
  Future<double?> getVideoDuration(XFile videoFile) async {
    try {
      ...
      final command =
          '-v error -show_entries format=duration -of default=noprint_wrappers=1:nokey=1 "${videoFile.path}"';
